     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                 <td class="menu-btn menu-icon-session menu-active menu-icon-session-active">
                     <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Mes séances</p></div></a>
                 </td>
             </tr>
             <tr class="menu-row" >
                   ...
                   <td colspan="4">
                       <center>
                        ...
                        <tr>
                                ...
                                <th class="table-headin">Date & heure prévues</th>
                                <th class="table-headin">Nombre max de réservations</th>
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Annuler la séance</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
                                }
            ...
            <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                ...
                <tr>
                    <td class="label-td" colspan="2">
                        <label for="name" class="form-label">Titre de la séance : </label>
                    </td>
                </tr>
                <tr>
                    <td class="label-td" colspan="2">
                ...
                <tr>
                    <td class="label-td" colspan="2">
                        <label for="spec" class="form-label"><b>Patients déjà inscrits pour cette séance :</b> ('.$result12->num_rows."/".$nop.')</label>
                        <br><br>
                    </td>
                </tr>
