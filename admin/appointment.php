        ...
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row">
                <td class="menu-btn menu-icon-doctor ">
                    <a href="doctors.php" class="non-style-link-menu "><div><p class="menu-text">Médecins</p></a></div>
                </td>
            </tr>
            <tr class="menu-row" >
                <td class="menu-btn menu-icon-schedule ">
                    <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Planning</p></div></a>
                </td>
            </tr>
            <tr class="menu-row">
                <td class="menu-btn menu-icon-appoinment menu-active menu-icon-appoinment-active">
                    <a href="appointment.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Rendez-Vous</p></a></div>
                </td>
            </tr>
            <tr class="menu-row" >
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr >
                ...
                <td>
                    <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Gestion des Rendez-Vous</p>
...
<select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
    <option value="" disabled selected hidden>Choisissez un médecin dans la liste</option><br/>
...
if($_GET){
    ...
    if($action=='add-session'){
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td>
                                <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Ajouter une nouvelle session.</p><br>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="text" name="title" class="input-text" placeholder="Nom de cette session" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="docid" class="form-label">Choisir un médecin : </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                                <select name="docid" id="" class="box" >
                                <option value="" disabled selected hidden>Choisir un médecin dans la liste</option><br/>';
        ...
        echo '              </select><br><br>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="number" name="nop" class="input-text" min="0"  placeholder="Le nombre final de rendez-vous dépend de ce nombre" required><br>
                            </td>
                        </tr>
                        <tr>
                            <td class="label-td" colspan="2">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input type="submit" value="Programmer cette session" class="login-btn btn-primary btn" name="shedulesubmit">
                            </td>
                        </tr>
                        </form>
                    </table>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                <br><br>
                    <h2>Session programmée.</h2>
                    <a class="close" href="schedule.php">&times;</a>
                    <div class="content">
                    La session <strong>'.substr($titleget,0,40).'</strong> a été programmée.<br><br>
                    </div>
                    <div style="display: flex;justify-content: center;">
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <div class="content">
                        Voulez-vous supprimer ce rendez-vous ?<br><br>
                        Patient : &nbsp;<b>'.substr($nameget,0,40).'</b><br>
                        Numéro du rendez-vous : <b>'.substr($apponum,0,40).'</b><br><br>
                    </div>
                    <div style="display: flex;justify-content: center;">
                    <a href="delete-appointment.php?id='.$id.'" class="non-style-link">
                        <button class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;">
                            <font class="tn-in-text">&nbsp;Oui&nbsp;</font>
                        </button>
                    </a>&nbsp;&nbsp;&nbsp;
                    <a href="appointment.php" class="non-style-link">
                        <button class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;">
                            <font class="tn-in-text">&nbsp;Non&nbsp;</font>
                        </button>
                    </a>
                    </div>
                    </center>
